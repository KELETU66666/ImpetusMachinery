package keletu.impetus_machinery.modularmachinery.crafting.requirement;
...
import keletu.impetus_machinery.modularmachinery.crafting.jei.ImpetusJEIComponent;
import keletu.impetus_machinery.modularmachinery.tile.MachineComponentImpetus;
...
public class RequirementImpetus extends ComponentRequirement<Impetus, RequirementImpetus.Type> {
    ...
    public static class Type extends RequirementType<Impetus, RequirementImpetus> {
        ...
        private Type() {
            setRegistryName(new ResourceLocation(MOD_ID, "impetus"));
        }
        ...
        switch (this.getActionType()) {
            case INPUT:
                ...
                if (tileComponent.hasEnoughImpetus(this.impetus.getAmount())) {
                    ...
                    return CraftCheck.failure("impetus_machinery.error.impetus.less");
                }
            case OUTPUT:
                ...
                if (tileComponent1.hasEnoughCapacity(this.impetus.getAmount())) {
                    ...
                    return CraftCheck.failure("impetus_machinery.error.impetus.space");
                }
            default:
